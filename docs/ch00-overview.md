...
这就是这本书存在的理由。它不是要让你成为 AI 工程师，而是给你一种**素养**：知道这台机器大致怎么运转，知道它在哪些地方可靠、哪些地方会把你带偏。拥有这种素养的人，不是被 AI 替代的人，而是能驾驭 AI 的人。
...
你可以尝试让ai帮你写一个网站并部署，也可以让ai收集一些尚未解决的数学问题，在里面挑选一些表述初等的定理用ai尝试证明，看自己能否跟上。或许，你会发现自己可以做到很多自己做不到的事，也或许你会逐渐发现，让ai处理自己完全无法审阅的项目是一件让人焦虑的事，这一点对于所有的ai驱动任务都是一致的。
